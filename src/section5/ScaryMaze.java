...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		new Robot().mouseMove(396, 544);
		
		//4. Add a mouse motion listener using:
		 addMouseMotionListener(this);
		JOptionPane.showMessageDialog(null, "Soldier, when gods all fall, would you destroy the core of the eye of devils and take the world back?");
	}
	...
	public void mouseMoved(MouseEvent e) {
	   ...
	   if (mouseColor<=-12000000 && mouseColor >= -13000000) {
		   scare();
		   JOptionPane.showMessageDialog(null,"Your soul was devoured and the world is returned to endless darkness...");
	   }
	   else if(mouseColor >= -13100000 && mouseColor <= 15000000 ) {
